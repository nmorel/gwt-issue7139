...
class MyCellBasedWidgetImplTrident extends CellBasedWidgetImpl {
  ...
  public MyCellBasedWidgetImplTrident() {
  ...
  private native void initFocusEventSystem() /*-{
    @com.google.gwt.user.cellview.client.MyCellBasedWidgetImplTrident::dispatchFocusEvent = $entry(function() {
      @com.google.gwt.user.cellview.client.MyCellBasedWidgetImplTrident::handleNonBubblingEvent(Lcom/google/gwt/user/client/Event;)($wnd.event);
    });
  }-*/;
  ...
  private native void sinkFocusEvents(Element elem) /*-{
    elem.attachEvent('onfocusin',
        @com.google.gwt.user.cellview.client.MyCellBasedWidgetImplTrident::dispatchFocusEvent);
